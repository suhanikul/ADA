...
flight_routes = [
    ...
    ('MAA', 'CCU'), ('HYD', 'CCU'), ('CCU', 'DEL'),('BLR', 'DEL'),  # These form SCCs
...
# Streamlit Interface
st.title("Airport SCC Finder")
st.image("AIRPORT FINDER.png")
...
if st.button("Check"):
    ...
    st.write(" Graph of Strongly Connected Components (SCCs)")